...
var WdCertOverrideService = function() {
  ...
  a && (CC["@mozilla.org/preferences-service;1"].getService(CI.nsIPrefBranch).setIntPref("test.currentTimeOffsetSeconds", 11491200), CC["@mozilla.org/preferences-service;1"].getService(CI.nsIPrefBranch).setIntPref("security.cert_pinning.enforcement_level", 0));
