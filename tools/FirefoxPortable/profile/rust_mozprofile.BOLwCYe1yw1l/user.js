...
user_pref("browser.download.dir", "C:\\Users\\luwe\\Documents\\Visual Studio 2015\\Projects\\WebAppCI\\WebAppCI.Tests\\bin\\Debug\\DownloadedFiles");
user_pref("browser.download.folderList", 2);
user_pref("browser.download.manager.showWhenStarting", false);
user_pref("browser.download.useToolkitUI", true);
user_pref("browser.helperApps.neverAsk.saveToDisk", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/xlsx,text/csv,text/plain,text/html");
...
user_pref("marionette.defaultPrefs.port", 61996);
